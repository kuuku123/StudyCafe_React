...
export const StatusBadge = styled.div<{ published: boolean }>`
  display: inline-flex;
  align-items: center;
  padding: 0.5rem 1rem;
  ...
  background: ${props => props.published 
    ? 'rgba(34, 197, 94, 0.1)' 
    : 'rgba(245, 158, 11, 0.1)'};
  color: ${props => props.published ? '#16a34a' : '#d97706'};
...
// Legacy support if needed, but we should aim to replace these in the component
